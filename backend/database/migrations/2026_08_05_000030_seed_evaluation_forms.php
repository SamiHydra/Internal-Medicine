        ...
        $forms = [
            [
                ...
                'fields' => [
                    ...
                    // Round-quality items are core: EvaluationScoring reads
                    // them as the consultant score inputs, so deactivating
                    // one would silently cap every future score.
                    ['Round quality', 'all_patients_reviewed', 'All patients reviewed', null, 'boolean', null, true, true],
                    ['Round quality', 'mgmt_plan_documented', 'Management plan documented', null, 'boolean', null, true, true],
                    ['Round quality', 'vte_assessed', 'VTE risk assessed', null, 'boolean', null, true, true],
                    ['Round quality', 'discharge_discussed', 'Discharge discussed', null, 'boolean', null, true, true],
                    ['Round quality', 'med_review_done', 'Medication review done', null, 'boolean', null, true, true],
                    ['Round quality', 'critical_labs_reviewed', 'Critical labs reviewed', null, 'boolean', null, true, true],
            ...
            [
                ...
                'target' => 'resident',
                'fields' => [
                    // All ten ACGME yes/no items are core: EvaluationScoring
                    // reads them as the resident score inputs.
                    ['Attendance & professionalism', 'on_time', 'Present & on time', null, 'boolean', null, true, true],
                    ['Attendance & professionalism', 'professional', 'Professional conduct', null, 'boolean', null, true, true],
                    ['Preparation & patient care', 'prepared', 'Knew patients; list & overnight events updated', null, 'boolean', null, true, true],
                    ['Preparation & patient care', 'management_plan', 'Appropriate, prioritized plan', null, 'boolean', null, true, true],
                    ['Medical knowledge', 'clinical_reasoning', 'Sound assessment & differential', null, 'boolean', null, true, true],
                    ['Communication', 'presentation_clear', 'Case presentation clear & concise', null, 'boolean', null, true, true],
                    ['Communication', 'communication', 'Effective with team / nursing / patient', null, 'boolean', null, true, true],
                    ['Documentation & systems', 'documentation_timely', 'Notes & orders complete and timely', null, 'boolean', null, true, true],
                    ['Documentation & systems', 'follow_through', 'Completed tasks; chased results & referrals', null, 'boolean', null, true, true],
                    ['Practice-based learning', 'responsive_feedback', 'Receptive to feedback & teaching', null, 'boolean', null, true, true],
